...
/**
 * The constraint check plugins for commands operating on approval tasks
 *
 * @Flow\Proxy(false)
 */
final class ApprovalTaskConstraintCheckPlugin implements ConstraintCheckPluginInterface
{
    ...
    public function checkSetTaskProperties(
        ...
        // setting task properties has no effect on objects
    }
